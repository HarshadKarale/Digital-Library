...
<html>
	...
	<h1 class="text-center mt-4 text-light">Welcome To SYBSc(Computer Science) Library</h1>
	...
	<div class="container mt-4">
		...
		<div class="row">
			<div class="col-md-12">
				<div class="card card-light responsive1">
					...
					<div class="card-body">
						<img src="images/sybcs/ebooks.jpg" class="books_img" style="height:250px;width:90%">
					</div>
    						...
    						<div class="modal-content">
      						...
      						<div class="modal-body">
	  							<div class="col-md-6 float-end">
		  							<img src="images/sybcs/ebooks.jpg" class="books_img" style="height:350px;width:100%">
								</div>
								<div class="col-md-6 float-end">
									<h3>Book Name</h3>
									<h5>Description</h5>
      						...
      						<div class="modal-footer">
        						...
        						<button class="btn btn-danger float-left" data-bs-toggle="modal" data-bs-target="#download_book_sybcs">Download</button>
      						</div>
    						</div>
  						</div>
						</div>
		...
		<div class="modal fade" id="download_book_sybcs" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  						<div class="modal-dialog">
    						<div class="modal-content">
