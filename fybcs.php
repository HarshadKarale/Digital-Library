...
<html>
	...
	<h1 class="text-center mt-4 text-light">Welcome To FYBSc(Computer Science) Library</h1>
	...
	<div class="container mt-4">
		...
		<div class="row">
			<div class="col-md-12">
				<div class="card card-light responsive1">
					...
					<div class="card-body">
						<img src="images/fybcs/desc_stat.jpg" class="books_img" style="height:250px;width:90%">
					</div>
					<div class="card-footer">
						<!-- View Button Design -->
						<!-- Button trigger modal -->
						<button type="button" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#view_book_desc_stat">
  						View
						</button>

						<!-- Modal -->
						<div class="modal fade" id="view_book_desc_stat" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    						...
    						<div class="modal-content">
      						...
      						<div class="modal-body">
	  							<div class="col-md-6 float-end">
		  							<img src="images/fybcs/desc_stat.jpg" class="books_img" style="height:350px;width:100%">
								</div>
								<div class="col-md-6 float-end">
									<h3>Book Name</h3>
									<h5>Description</h5>
      						...
      						<div class="modal-footer">
        						...
        						<button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#download_book_fybcs" class="btn btn-danger float-left">Download</button>
      						</div>
    						</div>
  						</div>
						</div>
				...
				<div class="card card-light responsive1">
					...
					<div class="card-body">
						<img src="images/fybcs/mathematical_statistic.jpg" class="books_img" style="height:250px;width:90%">
					</div>
					<div class="card-footer">
						<!-- View Button Design -->
						<!-- Button trigger modal -->
						<button type="button" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#view_book_mathematical_statistic">
  						View
						</button>

						<!-- Modal -->
						<div class="modal fade" id="view_book_mathematical_statistic" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  						<div class="modal-dialog">
    						<div class="modal-content">
      						<div class="modal-header">
								<div class="col-md-11">
      						...
      						<div class="modal-body">
	  							<div class="col-md-6 float-end">
		  							<img src="images/fybcs/mathematical_statistic.jpg" class="books_img" style="height:350px;width:100%">
								</div>
								<div class="col-md-6 float-end">
									<h3>Book Name</h3>
									<h5>Description</h5>
						...
						<div class="modal fade" id="view_book" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  						<div class="modal-dialog">
    						<div class="modal-content">
      						...
      						<div class="modal-body">
	  							<div class="col-md-6 float-end">
		  							<img src="images/fybcs/math.jpg" class="books_img" style="height:350px;width:100%">
								</div>
								<div class="col-md-6 float-end">
									<h3>Book Name</h3>
									<h5>Description</h5>
				...
				<div class="card card-light responsive1">
					...
					<div class="card-body">
						<img src="images/fybcs/dbms.jpg" class="books_img" style="height:250px;width:90%">
					</div>
					<div class="card-footer">
						<!-- View Button Design -->
						<!-- Button trigger modal -->
						...
						<div class="modal fade" id="view_book" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  						<div class="modal-dialog">
    						<div class="modal-content">
      						...
      						<div class="modal-body">
	  							<div class="col-md-6 float-end">
		  							<img src="images/fybcs/dbms.jpg" class="books_img" style="height:350px;width:100%">
								</div>
								<div class="col-md-6 float-end">
									<h3>Book Name</h3>
									<h5>Description</h5>
				...
				<div class="card card-light responsive1">
					...
					<div class="card-body">
						<img src="images/fybcs/rdbms.jpg" class="books_img" style="height:250px;width:90%">
					</div>
					<div class="card-footer">
						<!-- View Button Design -->
						<!-- Button trigger modal -->
						...
						<div class="modal fade" id="view_book" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  						<div class="modal-dialog">
    						<div class="modal-content">
      						...
      						<div class="modal-body">
	  							<div class="col-md-6 float-end">
		  							<img src="images/fybcs/rdbms.jpg" class="books_img" style="height:350px;width:100%">
								</div>
								<div class="col-md-6 float-end">
									<h3>Book Name</h3>
									<h5>Description</h5>
		...
		<div class="modal fade" id="download_book_fybcs" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  						<div class="modal-dialog">
    						<div class="modal-content">
